export const offset = (numDays: number, date: Date = new Date()): Date => {
    const daysAgo = new Date(date.getTime());
    daysAgo.setDate(daysAgo.getDate() + numDays);
    return daysAgo;
};

export const isBefore = (toCheck: Date, beforeDate: Date): boolean => {
    return toCheck.getTime() <= beforeDate.getTime();
};

export const isAfter = (toCheck: Date, afterDate: Date): boolean => {
...
export const formatTimeLeft = (date: Date, firstOnly: boolean = false): string => {
    const now = new Date();
 ...
 * @returns {string}
 */
export const formatDateRelatively = (date: Date, withTime: boolean = false): string => {
 ...
 */
export const formatDateTime = (date: Date, withYear: boolean = false): string => {
