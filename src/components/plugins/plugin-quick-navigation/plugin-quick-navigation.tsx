          ...
          <ul className="flex flex-wrap">
              {links.map(({label, href}) => (
                  <li className="flex-grow sm:flex-grow-0" key={label}>
                      <Link href={href} className="inline-block w-full sm:w-fit p-2 sm:p-4 border-b my-[-1px] dark:border-b-gray-700 rounded-t-lg hover:text-gray-600 hover:border-gray-400 dark:hover:text-gray-300 dark:hover:border-gray-500">
                          {label}
                      </Link>
                  </li>
              ))}
