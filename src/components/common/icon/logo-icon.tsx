...
// functional component that extends the normal html element props
export const LogoIcon: FC<React.HTMLAttributes<HTMLOrSVGElement>> = (props) => {
    return (
        <svg height="1000" viewBox="0 0 1000 1000" width="1000" xmlns="http://www.w3.org/2000/svg" {...props}>
            <title>GCNT Logo</title>
            <g id="letters">
                <path id="T" aria-label="T" className="s0" d="m932.7 543.5v86.7h-132.7v384.8h-109.4v-384.8h-132.7v-86.7z"/>
                <path
                    id="N"
                    aria-label="N"
                    className="s0"
